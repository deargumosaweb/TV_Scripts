	...
	<xsl:template match="/">
		...
		<Nucleus xmlns="http://www.redbeemedia.com/nucleus/metadata/ns/v1/standard_metadata">
			<id:Identifiers xmlns:id="http://www.redbeemedia.com/nucleus/metadata/ns/v1/identification">
				<id:Material_ID>
					<xsl:call-template name="replaceUnderscores">
						<xsl:with-param name="input" select="MarquisEDL/Sequence/Material_ID"/>
					</xsl:call-template>
				</id:Material_ID>
			...
			<an:Ancillary xmlns:an="http://www.redbeemedia.com/nucleus/metadata/ns/v1/ancillary">
				<an:File>
					<an:File_Name><xsl:value-of select="MarquisEDL/Sequence/Material_ID"/>.xml</an:File_Name>
			...
			<tn:Technical xmlns:tn="http://www.redbeemedia.com/nucleus/metadata/ns/v1/technical">
				<tn:Media_File_Name>
					<xsl:value-of select="/MarquisEDL/Sequence/UID"/>.mxf
				</tn:Media_File_Name>
				...
				<tn:Video_Format>
					<xsl:value-of select="/MarquisEDL/Sequence/Clip/AvidType"/>
				</tn:Video_Format>
				<tn:Display_Aspect_Ratio>
					<xsl:value-of select="/MarquisEDL/Sequence/Clip/ImageAspectRatio"/>
				</tn:Display_Aspect_Ratio>
				<tn:Start_Of_File>
